...
//    JumpStructure(date: "01.01.2023", location: "Skydive City", aircraft: "An-2", canopy: "Magellan-150", mission: NSLocalizedString("Tandem", comment: ""), height: "1500", time: "24", cutaway: NSLocalizedString("Yes", comment: ""), comment: "Самоотцеп")
]
